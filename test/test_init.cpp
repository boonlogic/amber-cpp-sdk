...
namespace {
    ...
    TEST(amber_sdk, ConstructorsNegative) {
        ...
        EXPECT_THROW(new amber_sdk("default", "nonexistent-license-file"), amber_except);
        EXPECT_THROW(new amber_sdk("nonexistent-license-id", "test/test.Amber.license"), amber_except);
        EXPECT_THROW(new amber_sdk("missing-username", "test/test.Amber.license"), amber_except);
        EXPECT_THROW(new amber_sdk("missing-password", "test/test.Amber.license"), amber_except);
        EXPECT_THROW(new amber_sdk("missing-server", "test/test.Amber.license"), amber_except);
